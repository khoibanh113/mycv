        ...
        return(
            ...
            <div class="row row-contact">
                    ...
                    <div className="col detail-contact">
                        <span>A free mobile app delivering Lancaster University services, resources, and information - at your fingertips - whenever you want them, from wherever you are!</span>
                    </div>
            </div>
            <div class="row row-contact">
                <div className="col-1 icon-contact">
