        ...
        return(
            <div >
                ...
                <div className='container-experience'>
                    <div className="row row-experience">
                        <b className="col-2 col-item">Decription:</b>
                        <span className="col">
                    ...
                    <div className="row row-experience">
                        <b className="col col-item">Teamsize:</b>
                        <span className="col">5</span>
                    </div>
                    <div className="row row-experience">
                        <b className="col col-item">Responsiblities:</b>
